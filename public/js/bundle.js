...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"addRequest.js":[function(require,module,exports) {
"use strict";
...
var addRequest = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, request) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Add request successfully');
              window.setTimeout(function () {
                (0, _alert.hideAlert)();
                location.replace(document.referrer);
              }, 1500);
  ...
  return function addRequest(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
if (requestBtn) {
  requestBtn.addEventListener('submit', function (e) {
    ...
    var request = document.querySelector('#requests').value;
    console.log({
      title: title,
      request: request
    });
    (0, _addRequest.addRequest)(title, request);
  });
}
